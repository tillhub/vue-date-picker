...
// CONCATENATED MODULE: ./src/components/VueDatePicker.vue?vue&type=template&id=381d488b&
...
/* harmony default export */ var VueDatePickervue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    formatDateToText: function formatDateToText(inputStart, inputEnd) {
      ...
      var start = this.dateFormat ? Object(date_fns["format"])(startDate, this.dateFormat) : startDate.toLocaleDateString(this.locale, options);
      var end = this.dateFormat ? Object(date_fns["format"])(endDate, this.dateFormat) : endDate.toLocaleDateString(this.locale, options);
